...
@if(config('ultreya.paypal-donations-enabled') && config('site.payments_paypal_hosted_button_id'))
    <li class="pb-3">Payments via PayPal, using debit/credit card or direct from bank account:
        ...
        You may optionally set up a recurring donation/payment by "checking the box" on the PayPal screen.
    </li>
@endif
