        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-row" role="form" method="POST" action="{{ action('LocationController@update', $location->id) }}">
                            @csrf @method('patch')
                        ...
                        @can('delete locations')
                            <form action="{{ action('LocationController@destroy', ['location' => $location->id]) }}" role="form" method="POST" class="form-inline float-right" onsubmit="return ConfirmDelete();">
                                @csrf @method('delete')
