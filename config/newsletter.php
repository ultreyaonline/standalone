...
return [
     ...
     */
    'driver_arguments' => [
        'api_key' => env('NEWSLETTER_API_KEY'), // get it from https://mailchimp.com/help/about-api-keys/ or https://us10.admin.mailchimp.com/account/api-key-popup/

        'endpoint' => env('NEWSLETTER_ENDPOINT'), // leave null for Mailchimp
    ],
