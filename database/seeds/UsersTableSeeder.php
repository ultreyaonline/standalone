...
class UsersTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $u = factory(\App\User::class)->states('male')->create([
        ...
        for ($i=0; $i < 10; $i++) {
            ...
            // build a couple
            $userM           = factory(\App\User::class)->states('male')->create([
                'sponsorID' => $sponsorID,
            ]);
            $userF           = factory(\App\User::class)->states('female')->create([
                'spouseID'   => $userM->id,
                'church'     => $userM->church,
